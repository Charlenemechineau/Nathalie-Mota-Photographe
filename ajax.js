jQuery(document).ready(function($) {
    ...
    $('.custom-select select').on('mouseenter', 'option', function() {
    $(this).parent().addClass('hovered-select');
    });

    $('.custom-select select').on('mouseleave', 'option', function() {
    $(this).parent().removeClass('hovered-select');
    });
